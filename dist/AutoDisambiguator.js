(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "nlptoolkit-morphologicalanalysis/dist/MorphologicalAnalysis/MorphologicalTag", "nlptoolkit-datastructure/dist/CounterHashMap"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AutoDisambiguator = void 0;
    ...
    class AutoDisambiguator {
        static isAnyWordSecondPerson(index, correctParses) {
            ...
            for (let i = index - 1; i >= 0; i--) {
                if (correctParses[i].containsTag(MorphologicalTag_1.MorphologicalTag.A2SG) ||
                    correctParses[i].containsTag(MorphologicalTag_1.MorphologicalTag.P2SG)) {
                    count++;
                }
            }
            return count >= 1;
        ...
        static selectCaseForParseString(parseString, index, fsmParses, correctParses) {
            ...
            switch (parseString) {
                ...
                case "ADJ$ADV$POSTP+PCABL":
                    if (AutoDisambiguator.hasPreviousWordTag(index, correctParses, MorphologicalTag_1.MorphologicalTag.ABLATIVE)) {
                        return "POSTP+PCABL";
                    }
                ...
                case "ADJ$ADV$NOUN+A3SG+PNON+NOM$POSTP+PCDAT":
                    if (AutoDisambiguator.hasPreviousWordTag(index, correctParses, MorphologicalTag_1.MorphologicalTag.DATIVE)) {
                        return "POSTP+PCDAT";
                    }
                    if (AutoDisambiguator.isNextWordNoun(index, fsmParses)) {
                        return "ADJ";
                ...
                case "ADV$POSTP+PCINS":
                    if (AutoDisambiguator.hasPreviousWordTag(index, correctParses, MorphologicalTag_1.MorphologicalTag.INSTRUMENTAL)) {
                        return "POSTP+PCINS";
                    }
                    return "ADV";
    ...
    exports.AutoDisambiguator = AutoDisambiguator;
});
//# sourceMappingURL=AutoDisambiguator.js.map